# # ============================= SELECT SORT ALGORITHM PYTEST =============================

# # file name to big, using alias
# import SelectionAlgorithm as sel
# import pandas as pd
# import time
...
#     assert sel.Selection_Sort(sorted_data) == sorted_data
#     end_time = time.time()
...
#     rugbyAgeData = []
#     start_time = time.time()
#     assert sel.Selection_Sort(rugbyAgeData) == []
#     end_time = time.time()
#     execution_time = end_time - start_time
...
# def test_Unsorted():
#     start_time = time.time()
#     assert sel.Selection_Sort(rugbyAgeData) == sorted_data
#     end_time = time.time()
#     execution_time = end_time - start_time
...
#     start_time = time.time()
#     assert sel.Selection_Sort(reverse_list) == sorted_data
#     end_time = time.time()
#     execution_time = end_time - start_time
...
#     start_time = time.time()
#     assert sel.Selection_Sort(duplicate) == sorted(duplicate)
#     end_time = time.time()
#     execution_time = end_time - start_time
